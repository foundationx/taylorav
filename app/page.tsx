...
const testimonials = [
  ...
  {
    quote:
      "Their directors handled union coordination, hybrid streaming, and lighting cues so our keynote looked and felt like a national broadcast.",
    name: "Serena Lowe",
  ...
  {
    quote:
      "From Park City snowstorms to Vegas ballrooms, Taylor AV shows up prepared with redundant gear and the people to run it.",
    name: "Marcus Diaz",
    title: "Tour Manager",
...
const homeFaq = [
  {
    ...
    answer:
      "Major productions are typically reserved 6–8 weeks prior to rehearsal, but we keep rapid-response crews on standby for civic or touring emergencies.",
  },
  {
    question: "Do you travel outside Utah?",
    answer:
      "Yes. We regularly support Las Vegas, Denver, and West Coast corridors with the same Utah-based crews, trucking, and redundant equipment.",
  },
  {
    question: "Can you handle streaming + in-room production simultaneously?",
    answer:
      "Hybrid control rooms are part of our default scope. We provide isolated audio mixes, redundant encoders, and stage management so neither audience feels secondary.",
  },
];
...
const serviceHighlights = [
  {
    ...
    body: "Technical directors, cue-to-cue oversight, and rigging crews keep lighting, audio, and scenic intent aligned with your run-of-show so the event looks curated and feels uncompromised.",
  },
  {
    title: "Rental infrastructure",
    body: "Line arrays, LED walls, consoles, playback servers, and live-stream capture are pre-staged in Riverton with redundant cabling and everyday calibrations to keep things on cue.",
  },
  {
    title: "Staging + crews",
    body: "Stage decks, truss, hydraulic Stageline platforms, and mobile studios arrive with trained riggers who honor union fast lanes, load-in windows, and meticulous strike logistics.",
  },
];
...
const proofItems = [
  ...
  },
  {
    ...
    body: "Sound, video, lighting, and truss for acts like Rascal Flatts, Imagine Dragons, Michael W. Smith, and touring collectives stay polished thanks to touring-grade crews.",
  },
  {
    title: "Live streaming & broadcast",
    body: "Mix, capture, and remote-control packages move with the show so a hybrid keynote or broadcasted gala stays on time with high-fidelity signal paths.",
  },
];
...
const mountainHighlights = [
  {
    ...
    body: "Our contract underlines accountability, competitive pricing, and the transparency public agencies expect, making Taylor AV a trusted partner for civic, state, and education teams.",
  },
  {
    title: "Mountain-ready logistics",
    body: "Park City resorts, canyon amphitheaters, and remote festival sites are no surprise—our crews rehearse power plans, slope access, and long-haul trucking long before load-in.",
  },
  {
    title: "Strategic partners",
    body: "Entertainment directors, venues, and production designers rely on our local presence plus touring resources to keep shows beautiful and punctual.",
  },
];
          ...
          <div className="glass-panel">
            ...
            <div className="media-card media-card-home">
              ...
              <div className="media-card-content">
                ...
                <p>
                  Instead of juggling multiple vendors, producers work with a
                  single Taylor AV partner who owns every cable, amp, deck, and
                  cue sheet. Crews respect venue rules while keeping the
                  experience polished like a national integrator but only a
                  local call away.
                </p>
                <p>
                  Our teams keep equipment staged in Riverton for quick regional
                  response, and we still travel with rigs and crew packages when
                  your show calls for Las Vegas, Denver, or neighboring states.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="glass-panel">
            ...
            <p className="content-narrow">
              We balance boutique responsiveness with touring infrastructure.
              Our inventory and crew cadence mirror the discipline of a remote
              integrator, while our engineers live inside the Wasatch corridors,
              which is why we keep production crews in Salt Lake City, Ogden,
              and Park City every week.
            </p>
            <div className="grid">
      ...
      <section className="section">
        <div className="container">
          <div className="section-heading">
            ...
            <p className="content-narrow">
              We highlight the Wasatch Front because crews live nearby, but if a
              venue or major touring act wants Taylor AV anywhere—just ask.
              Transparent travel logistics, per diem, and freight plans keep
              your budget intact.
            </p>
          </div>
      ...
      <section className="section">
        <div className="container">
          <div className="cta-banner">
            ...
            <p>
              We pair local leadership with the touring infrastructure you
