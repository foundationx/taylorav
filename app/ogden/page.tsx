...
export const metadata: Metadata = {
  ...
  description: 'Ogden arenas, Weber County festivals, and community gatherings backed by Taylor AV crews and rentals.'
};
        ...
        <div className="container">
          <div className="glass-panel">
            ...
            <p className="content-narrow">
              We know the local permitting offices and venue contacts, which keeps Ogden activations on time and under budget.
            </p>
            <div className="grid">
              {highlights.map((item) => (
